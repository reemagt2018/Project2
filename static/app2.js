...
xText
  .append("text")
  .attr("y", 0)
  .attr("data-name", "PopulationRanking")
  .attr("data-axis", "x")
...
xText
  .append("text")
  .attr("y", 26)
  .attr("data-name", "EducationalOverallRank")
  .attr("data-axis", "x")
  .attr("class", "aText inactive x")
  .text("Educational OverallRank");

  xText
    .append("text")
    .attr("y", 52)
    .attr("data-name", "MobileOverallrank")
    .attr("data-axis", "x")
    .attr("class", "aText inactive x")
    .text("Mobile Overallrank");

    xText
      .append("text")
      .attr("y", 78)
      .attr("data-name", "Diversityoverallrank")
      .attr("data-axis", "x")
      .attr("class", "aText inactive x")
      .text("Diversity overallrank");
...
// yText
  //.append("text")
  //.attr("x", 0)
  //.attr("data-name", "Transit_ranking")
  //.attr("data-axis", "y")
  //.attr("class", "aText inactive y")
  //.text("Transit ranking");
...
function visualize(theData) {
  ...
  var curX = "TransitRank";
  var curY = "OverallRank";
  ...
  theCircles
    ...
    .on("mouseover", function(d) {
      ...
      toolTip.show(d);
      // Highlight the state circle's border
      d3.select("." + d.City_cd).style("stroke", "#323232");
    })
    .on("mouseout", function(d) {
      // Remove tooltip
      toolTip.hide(d);
      // Remove highlight
      d3.select("." + d.City_cd).style("stroke", "#e3e3e3");
    });
